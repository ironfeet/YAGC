...
ares-install ./build/yagc_0.0.13_all.ipk -d <device-name>
...
The project uses GitHub Actions to automate the release process. Pushing a tag (e.g., `v0.0.13`) will automatically build the Vue app and package it into an `.ipk` file for download on the Releases page.
